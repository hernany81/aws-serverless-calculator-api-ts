...
describe("Subtraction operation", () => {
  ...
  test("Happy path", async () => {
    ...
    // act
    const result = await subtraction.execute({
      userId,
      creditBalance,
      input1,
      input2,
    ...
    expect(savedOperationRecord.type).toBe(OperationType.SUBTRACTION);
    ...
    expect(savedOperationRecord.operationResult).toBe("1.167");
